...
class BlogpostsControllerTest < ActionController::TestCase
  ...
  test "should create blogpost" do
    assert_difference('Blogpost.count') do
      post :create, blogpost: { body: @blogpost.body, image: @blogpost.image, link: @blogpost.link, subtitle: @blogpost.subtitle, title: @blogpost.title }
    end
  ...
  test "should update blogpost" do
    patch :update, id: @blogpost, blogpost: { body: @blogpost.body, image: @blogpost.image, link: @blogpost.link, subtitle: @blogpost.subtitle, title: @blogpost.title }
    assert_redirected_to blogpost_path(assigns(:blogpost))
  end
