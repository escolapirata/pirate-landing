...
class PathsControllerTest < ActionController::TestCase
  ...
  test "should create path" do
    assert_difference('Path.count') do
      post :create, path: { creator_id: @path.creator_id, description: @path.description, image: @path.image, name: @path.name, owner_id: @path.owner_id }
    end
  ...
  test "should update path" do
    patch :update, id: @path, path: { creator_id: @path.creator_id, description: @path.description, image: @path.image, name: @path.name, owner_id: @path.owner_id }
    assert_redirected_to path_path(assigns(:path))
  end
